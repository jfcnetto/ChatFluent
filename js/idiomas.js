...
const uiTranslations = {
    pt: {
        ...
        share: "📱 Compartilhe",
        dbError: "Desculpe! O banco de dados para aprender {lang} ainda está sendo construído. Volte em breve!"
    },
    en: {
        ...
        share: "📱 Share",
        dbError: "Sorry! The database to learn {lang} is still under construction. Come back soon!"
    },
    es: {
        ...
        share: "📱 Compartir",
        dbError: "¡Lo siento! La base de datos para aprender {lang} aún está en construcción. ¡Vuelve pronto!"
    },
    fr: {
        ...
        share: "📱 Partager",
        dbError: "Désolé ! La base de données pour apprendre {lang} est encore en construction. Revenez bientôt !"
    },
    it: {
        ...
        share: "📱 Condividi",
        dbError: "Spiacenti! Il database per imparare {lang} è ancora in costruzione. Torna presto!"
    },
    de: {
        ...
        share: "📱 Teilen",
        dbError: "Entschuldigung! Die Datenbank zum Lernen von {lang} befindet sich noch im Aufbau. Kommen Sie bald wieder!"
    },
    nl: {
        ...
        share: "📱 Delen",
        dbError: "Sorry! De database om {lang} te leren is nog in aanbouw. Kom snel terug!"
    },
    pl: {
        ...
        share: "📱 Udostępnij",
        dbError: "Przepraszamy! Baza danych do nauki {lang} jest jeszcze w budowie. Wróć wkrótce!"
    },
    ru: {
        ...
        share: "📱 Поделиться",
        dbError: "Извините! База данных для изучения {lang} все еще находится в разработке. Возвращайтесь скорее!"
    },
    tr: {
        ...
        share: "📱 Paylaş",
        dbError: "Üzgünüz! {lang} öğrenmek için veritabanı henüz yapım aşamasındadır. Yakında tekrar gelin!"
    },
    ja: {
        ...
        totalPoints: "合計スコア：", nextLevel: "次のレベルへ", restartJourney: "最初からやりoldなす", tryAgainBtn: "もう一度試す",
        share: "📱 シェアする",
        dbError: "申し訳ありません！{lang}を学習するためのデータベースは現在構築中です。またお越しください！"
    }
};
